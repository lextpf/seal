 ...
 * @brief Wipes the master password after user idle time or Windows session lock.
 ...
 *   activity (keys, mouse buttons, wheel, mouse move); a coarse 30 s
...
public:
    ...
    /// @param watched Watched object (unused; app-wide filter).
